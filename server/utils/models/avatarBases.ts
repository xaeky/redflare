...
import type { AvatarBaseFlagsType } from '~~/shared/enums/Commissions';
...
const getAllCached = defineCachedFunction(
  async (excludeFlags: AvatarBaseFlagsType = 0) => await getAll(excludeFlags),
  {
