...
const { formState, schema, submit, busy } = useKnowledgeBaseConfigMutation(
...
<template>
  ...
  >
    ...
    >
      <UFormField
        name="helpLinks.howToUploadAvatarUrl"
        label="URL to 'How to upload private avatar'"
      >
        <UInput
          v-model="(formState.helpLinks.howToUploadAvatarUrl as string)"
          placeholder="https://path.to/guide"
        />
      </UFormField>
    </UForm>
    <template #footer>
