...
onMounted(() => {
  _.assign(
    ...
    _.pick(props.transaction, Object.keys(billingTransactionSchema.shape)),
  );
});
</script>
...
<template>
  <UModal title="Edit billing transaction log" :dismissible="false">
    <template #body>
      <div class="space-y-4">
        <UAlert
          description="For security reasons, you can only edit some fields of payment transactions."
          variant="soft"
          color="neutral"
