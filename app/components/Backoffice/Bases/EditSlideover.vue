...
<template>
  <USlideover
    ...
    @close:prevent="handleUpdateOpen"
    :dismissible="!avatarBaseFormStore.isModified"
  >
    <template #body>
      ...
      <div class="flex items-center justify-between w-full">
        <div class="flex items-center">
          <UButton
            ...
            color="error"
            variant="soft"
            :loading="avatarBaseFormStore.destroyBusy"
        ...
        <div class="flex w-full justify-end gap-2">
          <UButton
            ...
            color="neutral"
            icon="i-lucide-save"
            :loading="avatarBaseFormStore.updateBusy"
            :disabled="!avatarBaseFormStore.isModified"
          />
        </div>
      </div>
    </template>
